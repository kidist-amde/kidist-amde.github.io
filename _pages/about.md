...
* **Continual generative retrieval:** developing parametric-memory mechanisms that incorporate new documents while preserving previously learned knowledge.
* **Decoding and robustness:** studying how constrained generation and look-ahead guidance affect recall under query variation and cross-lingual shift.
* **Multilingual and low-resource retrieval:** developing retrieval models and benchmarks for Amharic and other underrepresented languages.
